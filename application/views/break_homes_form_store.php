		...
		<div class="box-body">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="victim_name" name="victim_name" placeholder="ชื่อ - สกุล"
						value="<?php echo $victim_name;?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">
						<textarea class="form-control" rows="3" id="assets_loses" name="assets_loses" placeholder="ทรัพย์สินที่เสียหาย"><?php echo $address;?></textarea>
					</div>
                </div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">
						<label>
							<input type="radio" name="status" class="flat-red" value="active" <?php if ($status=='active' ) { echo "checked"
							;}?>>&nbsp;Active
							<input type="radio" name="status" class="flat-red" value="disabled" <?php if ($status=='disabled' ) { echo
							"checked" ;}?>>&nbsp;Disable
						</label>
					</div>
				</div>
