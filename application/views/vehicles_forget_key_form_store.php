		...
		<div class="box-body">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<label>
							<input type="radio" name="status" class="flat-red" value="stable" <?php if ($status == 'stable')
{
    echo 'checked'
    ;}?>>&nbsp;ปกติ
							<input type="radio" name="status" class="flat-red" value="not-stable" <?php if ($status == 'not-stable')
{
    echo
        'checked';}?>>&nbsp;ไม่ปกติ
						</label>
