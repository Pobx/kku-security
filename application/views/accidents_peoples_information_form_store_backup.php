<div class="form-group">
	...
	<div class="col-sm-4">
		<label>
			<input type="radio" name="victim_type" class="flat-red" value="victim" <?php if ($victim_type == 'victim')
{
    echo
        'checked';}?>>&nbsp;ผู้ประสบเหตุ
			<input type="radio" name="victim_type" class="flat-red" value="parties" <?php if ($victim_type == 'parties')
{
    echo
        'checked';}?>>&nbsp;คู่กรณี
		</label>
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<label>
			<input type="radio" name="people_type" class="flat-red" value="officer" <?php if ($people_type == 'officer')
{
    echo
        'checked';}?>>&nbsp;บุคลากร
			<input type="radio" name="people_type" class="flat-red" value="student" <?php if ($people_type == 'student')
{
    echo
        'checked';}?>>&nbsp;นักศึกษา
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<label>
			<input type="radio" name="injury_type" class="flat-red" value="injury" <?php if ($injury_type == 'injury')
{
    echo
        'checked';}?>>&nbsp;บาดเจ็บ
			<input type="radio" name="injury_type" class="flat-red" value="dead" <?php if ($injury_type == 'dead')
{
    echo
        'checked';}?>>&nbsp;เสียชีวิต
		</label>
