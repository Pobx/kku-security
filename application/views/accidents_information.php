	...
	<?php if($accident_asset_destroyed['numrows']>0 ){ ?>
		<?php foreach($accident_asset_destroyed as $key =>  $data){ ?>
			<div class="form-group" id="assets_name_0">
				<label for="" class="col-sm-2 control-label"><?php echo  $key == 0 ? 'ทรัพย์สินราชการเสียหาย' : ''; ?></label>
				...
				<div class="col-sm-1"><a href="javascript:append_assets_amount(<?=$data['id'];?>)" class="btn btn-info sm"><b>+</b></a></div>
				<div class="col-sm-1"><a href="javascript:_delete(<?=$data['id'];?>)" class="btn btn-danger sm"><b>-</b></a></div>
